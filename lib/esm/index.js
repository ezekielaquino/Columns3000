...
export var Columns = function (_a) {
    ...
    return (React.createElement(WrapColumns, __assign({ className: className, columns: columns, justify: justify, gutter: gutter, breakpoint: breakpoint }, rest), React.Children.map(React.Children.toArray(children).filter(Boolean), function (child) { return React.cloneElement(child, { breakpoint: breakpoint }); })));
};
export var Column = function (_a) {
    ...
    return (React.createElement(WrapColumn, __assign({ className: className, span: span, grow: grow, breakpoint: breakpoint }, rest), children));
};
