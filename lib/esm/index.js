...
export var Columns = function (_a) {
    ...
    return (React.createElement(WrapColumns, __assign({ columns: columns, justify: justify, gutter: gutter, breakpoint: breakpoint }, rest), React.Children.map(React.Children.toArray(children).filter(Boolean), function (child) { return React.cloneElement(child, { breakpoint: breakpoint }); })));
};
