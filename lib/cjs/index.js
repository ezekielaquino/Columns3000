...
var Columns = function (_a) {
    ...
    return (react_1.default.createElement(WrapColumns, __assign({ columns: columns, justify: justify, gutter: gutter, breakpoint: breakpoint }, rest), react_1.default.Children.map(children, function (child) {
        return react_1.default.cloneElement(child, { breakpoint: breakpoint });
    })));
};
