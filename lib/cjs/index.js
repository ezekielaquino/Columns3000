...
var Columns = function (_a) {
    ...
    return (react_1.default.createElement(WrapColumns, __assign({ columns: columns, justify: justify, gutter: gutter, breakpoint: breakpoint }, rest), react_1.default.Children.map(react_1.default.Children.toArray(children).filter(Boolean), function (child) { return react_1.default.cloneElement(child, { breakpoint: breakpoint }); })));
};
...
var Column = function (_a) {
    ...
    return (react_1.default.createElement(WrapColumn, __assign({ span: span, grow: grow, breakpoint: breakpoint }, rest), children));
};
